...
def _mobilenetv3(arch, mode, pretrained, **kwargs):
    model = MobileNetV3(mode, **kwargs)
...
def mobilenet_v3_large(pretrained=False, **kwargs):
    """
    Constructs a MobileNetV3_Large.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    return _mobilenetv3('mobilenet_v3_large', 'large', pretrained, **kwargs)

def mobilenet_v3_small(pretrained=False, **kwargs):
    """
       Constructs a MobileNetV3_Small.
       Args:
           pretrained (bool): If True, returns a model pre-trained on ImageNet
       """
    return _mobilenetv3('mobilenet_v3_small', 'small', pretrained, **kwargs)